        ...
        <div className="rounded-xl overflow-hidden border border-gray-200 mt-5">
            ...
            <div className="bg-white p-4">
                ...
                <a
                    ...
                    className="flex items-center justify-center gap-2 w-full border border-gray-300 rounded-lg py-2.5 text-gray-700 font-medium text-sm hover:bg-gray-50 transition-colors mb-2"
                >
